...
cp_values <- seq(-0.9, -0.4, 0.1) # Ejemplo de valores para 'cp'
maxdepth_values <- seq(2, 8, 2)
minsplit_values <- seq(100, 1000, 100)
minbucket_values <- seq(50, 100, 10) # Ejemplo de valores para 'minbucket'
